...
export const mockScanReport: ScanReport = {
  ...
  summary: {
    ...
    totalLines: 4280,
    languages: [
      { name: "Python", percentage: 68, label: "68%", color: "hsl(210, 80%, 55%)" },
      { name: "JavaScript", percentage: 18, label: "18%", color: "hsl(50, 90%, 55%)" },
      { name: "HTML", percentage: 9, label: "9%", color: "hsl(15, 80%, 55%)" },
      { name: "CSS", percentage: 5, label: "5%", color: "hsl(262, 80%, 60%)" },
    ],
    healthScore: 73,
